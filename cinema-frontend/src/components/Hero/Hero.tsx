            ...
            >
                <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <div className="mt-8 flex flex-wrap gap-4 justify-center text-center">
                        <a
                            href="#"
                            className="block w-full rounded bg-white px-12 py-3 text-lg font-medium text-blue-500 shadow hover:text-blue-700 focus:outline-none focus:ring active:text-blue-500 sm:w-auto"
                        >
                            CONHEÇA MAIS
                        </a>
                    </div>
