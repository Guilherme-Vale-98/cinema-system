...
const ListSection = (props: Props) => {
  ...
  return (
    <section className='flex text-white bg-sky-900 flex-wrap relative w-full'
    >
      ...
      <div className='md:w-4/5 md:mx-auto w-full overflow-scroll bg-gray-800 my-10 mds:rounded-xl'>
